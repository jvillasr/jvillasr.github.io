...
- Website profile picture now uses the approved face edit; the original portrait is preserved as `assets/images/profilepic.png`.
...
- README rewritten for this site and leftover WhatATheme config references removed
